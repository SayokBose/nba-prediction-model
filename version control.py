from nba_api.stats.endpoints import PlayerGameLogs, TeamEstimatedMetrics, BoxScoreAdvancedV2
import pandas as pd
...
def getNBADF(season, season_type = 0, season_segment = 0):
    ...
    organized_df.drop(columns=['E_DEF_RATING', 'E_DEF_RATING_RANK', 'E_PACE_RANK'], inplace=True)
...
def getPastData(season):
    ...
    df22 = getNBADF(pastSzn, season_type, season_segment = 'Post All-Star')
...
def getL15(season, players):
    ...
    valid_players = player_counts[player_counts >= 25].index
